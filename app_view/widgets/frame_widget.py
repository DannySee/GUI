...
class FrameWidget(QFrame):
    def __init__(self, style_sheet, layout=None, minimum_width=100, maximum_width=None, fixed_height=None,
                 maximum_height=None, vertical_size_policy=QSizePolicy.Policy.MinimumExpanding, 
                 horizontal_size_policy=QSizePolicy.Policy.MinimumExpanding, visible=True):
